...
import top.ppnt.arcsoft.face.utils.FaceConstans;

public class FaceEngineTest {

  // 从官网获取
  private static String appId = FaceConstans.APP_ID;
  private static String sdkKey = FaceConstans.SDK_KEY_WIN;

  public static void main(String[] args) {

    String filepath = "D:\\opencv-images\\face\\huge.png";
    ...
    // 人脸检测2
    ImageInfo imageInfo2 = getRGBData(new File(filepath));
    ...
    errorCode = faceEngine.extractFaceFeature(imageInfo2.getImageData(), imageInfo2.getWidth(), imageInfo2.getHeight(),
        imageInfo.getImageFormat(), faceInfoList2.get(0), faceFeature2);
    System.out.println("特征值大小：" + faceFeature.getFeatureData().length);
    ...
    System.out.println("3D角度：" + face3DAngleList.get(0).getPitch() + "," + face3DAngleList.get(0).getRoll() + ","
    ...
    errorCode = faceEngine.processIr(imageInfoGray.getImageData(), imageInfoGray.getWidth(), imageInfoGray.getHeight(),
        imageInfoGray.getImageFormat(), faceInfoListGray, configuration2);
    // IR活体检测
